...
namespace flashgg {
    ...
    class BothEBUntaggedTagProducer : public EDProducer
    {

    public:
        BothEBUntaggedTagProducer( const ParameterSet & );
    private:
    ...
    BothEBUntaggedTagProducer::BothEBUntaggedTagProducer( const ParameterSet &iConfig ) :
        ...
        requireScaledPtCuts_   ( iConfig.getParameter<bool> ( "RequireScaledPtCuts" ) )
    {
        ...
        produces<vector<BothEBUntaggedTag> >();
    }

    int BothEBUntaggedTagProducer::chooseCategory( float mvavalue )
    {
    ...
    void BothEBUntaggedTagProducer::produce( Event &evt, const EventSetup & )
    {
...
//   const PtrVector<flashgg::DiPhotonMVAResult>& mvaResultPointers = mvaResults->ptrVector();
        ...
        std::unique_ptr<vector<BothEBUntaggedTag> > tags( new vector<BothEBUntaggedTag> );
...
//JTao : EB+EB
            ...
            BothEBUntaggedTag tag_obj( dipho, mvares );
            ...
            //std::cout << "I am BothEBUntaggedTagProducer, catnum is: " << catnum << std::endl;
...
typedef flashgg::BothEBUntaggedTagProducer FlashggBothEBUntaggedTagProducer;
DEFINE_FWK_MODULE( FlashggBothEBUntaggedTagProducer );
// Local Variables:
// mode:c++
