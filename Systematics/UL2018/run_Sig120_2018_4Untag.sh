...
#
fggRunJobs.py --load sig120_UL2018.json -d Sig120_4Unatg_retrainBDT_MassWindow_final -x cmsRun workspaceStd_OnlyUntag.py maxEvents=-1 -n 200 -q ${queue} -H -D -P  --no-use-tarball  --no-copy-proxy dumpWorkspace=False dumpTrees=True  doSystematics=True useParentDataset=False doPdfWeights=False
