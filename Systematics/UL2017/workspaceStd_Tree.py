...
##JTao MiniTree
customize.options.register('MiniTreeOnly',
                           True,
...
print 'JTao : MiniTreeOnly '+str(customize.MiniTreeOnly)
...
elif customize.MiniTreeOnly:  ##JTao
    process.flashggTagSequence.remove(process.flashggVBFTag)
    process.flashggTagSequence.remove(process.flashggVHMetTag)
    process.flashggTagSequence.remove(process.flashggWHLeptonicTag)
    process.flashggTagSequence.remove(process.flashggZHLeptonicTag)
...
if customize.MiniTreeOnly: #JTao
     from flashgg.Systematics.UntagMiniTreeCustomize import UntagMiniTreeCustomize
     mtc = UntagMiniTreeCustomize(process, customize, customize.metaConditions)
     if customize.processId == "Data":
	 minimalVariables = mtc.DataVariablesToDump()
     else:
       	 minimalVariables = mtc.variablesToDump()
     systematicVariables = mtc.systematicVariables()
