...
if customize.UntagsOnly:  ##JTao
    ...
    #process.flashggUntagged.Boundaries = cms.vdouble(0.127292, 0.801304, 0.865415, 0.935354) #buggy retrained BDT boundaries
    #process.flashggUntagged.Boundaries = cms.vdouble(0.766959, 0.861602, 0.929982, 0.954566) #retrained BDT boundaries
    #process.flashggUntagged.Boundaries = cms.vdouble(0.7200, 0.8619, 0.9329, 0.9708) #retrained MassWindow BDT boundaries
    process.flashggUntagged.Boundaries = cms.vdouble(0.7298, 0.8701, 0.9301, 0.9701) #retrained nosigmarv BDT boundaries
